...
import { CreditCard, Save, PlugZap, AlertTriangle, ShieldAlert } from 'lucide-react';
    ...
    <div className="flex flex-col gap-6 animate-page-enter">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h1 className="text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white">Payment Integration</h1>
        ...
        <>
          <ATMCard className="glass-card">
            <div className="flex items-center justify-between gap-4">
              <div>
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">Use Payment Integration</h2>
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400 font-semibold">
                  Master switch. When off, online payments are BLOCKED — merchants see a clear
                  "online payment not enabled" message and can pay offline instead; invoice
                  auto-charge is skipped. Save to apply.
                </p>
              </div>
          ...
          <ATMCard className="glass-card">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-bold text-gray-900 dark:text-white">Payment Provider</h2>
            </div>
